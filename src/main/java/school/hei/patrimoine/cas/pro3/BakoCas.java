...
public class BakoCas extends Cas {
    ...
    public Set<Possession> possessions() {
        ...
        var compteCourantBNI = new Compte("Compte courant BNI", au_8_AVRIL_2025, new Argent(2_000_000, MGA));
        var compteEpargneBMOI = new Compte("Compte Epargne BMOI", au_8_AVRIL_2025, new Argent(625_000, MGA));
        var coffreFort = new Compte("espece dans le coffre fort", au_8_AVRIL_2025, new Argent(1_750_000, MGA));
